<div class="mi-pricetable mi-pricetable--3cols mi-pricetable--collapse js-mi-pricetableTabs">
	...
	<div class="Tablist" role="tablist">
		<button class="Tab" role="tab" aria-selected="true">Website-Pflege nach Aufwand</button>
		<button class="Tab" role="tab" aria-selected="false">Care-Paket Proaktiv Wachstum</button>
		<button class="Tab" role="tab" aria-selected="false">Care-Paket Individuell</button>
	</div>

<!--Col 1-->
    <div style="order:0;" class="mi-pricetable-cell mi-no-border">
        <img class="aligncenter align-bottom" src="https://dev.mainetcare.de/wp-content/uploads/2019/06/blumentopf.svg" width="40">
    </div>
	...
	<div style="order:3;" class="mi-pricetable-cell">
        <ul class="mi-ticks mi-smaller mi-med">
            ...
            <li>Reaktionszeit max. 3 Tage</li>
            <li>Dokumentation aller Tätigkeiten</li>
            <li>Ein fester Ansprechpartner, der Sie und Ihre Belange kennt</li>
            <li>Keine Vertragslaufzeit, Sie beauftragen uns, wir legen los</li>
	...
	<div style="order:3;" class="mi-pricetable-cell">
        <ul class="mi-ticks mi-smaller mi-med">
            ...
            <li>Telefonischer Support und -Beratung inklusive - wird nicht für Kontingent berechnet!</li>
            <li>Proaktive Onpage-SEO-Maßnahmen</li>
            <li>Matomo-Analytics: Einrichtung Software und Aufzeichnung Benutzerverhalten</li>
            <li>Analytics-Auswertung und Beratung 1 x pro Quartal inklusive</li>
            <li>5% Rabatt auf weitere Standard-Aufträge.</li>
